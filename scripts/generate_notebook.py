...
NOTEBOOK_PATH = "notebooks/colab_embedder.ipynb"
...
cells = [
    ...
    },
    {
        ...
        "source": [
            ...
            "import gc\n",
            "\n",
            "# Hata yapma ihtimaline karşı her iki ihtimali de destekleyelim\n",
            "if os.path.exists('sample_data/sample_products.jsonl'):\n",
            "    PRODUCTS_FILE = 'sample_data/sample_products.jsonl'\n",
            "    REVIEWS_FILE = 'sample_data/sample_reviews.jsonl'\n",
            "else:\n",
    ...
    },
    {
        ...
        "outputs": [],
        "source": [
            "# --- GPU İLE EMBEDDING (HATA DÜZELTİLDİ) ---\n",
            ...
            "\n",
            "# Bellek taşmasını engellemek için kelime sınırını (max_length) 512 yapıyoruz.\n",
            ...
            "\n",
            "# Colab T4 GPU (15GB) için en güvenli batch size 16 veya 32'dir.\n",
